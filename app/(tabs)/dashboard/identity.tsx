...
// // Import your silver icon component
...
//   const handleNext = () => {
//     // Navigate to next screen based on selected ID type
//     router.push("/iban");
//   };
...
//               <Image
//                 source={require("../../../assets/images/dashboard/silver-icon.png")}
//                 style={{
//                   width: 200,
//                   height: 200,
//                 }}
...
//               className="text-[#D4AF37] text-[28px] text-center leading-[38px] mb-3"
//             >
//               Confirm Your Real Identity{"\n"}to Join as{" "}
//               <Text style={{ color: "#FCCD34" }}>Talent</Text>
//             </Text>

//             {/* Subtitle */}
//             <Text
//               style={{ fontFamily: FONT.Regular }}
//               className="text-[#FFFFFF80] text-[14px] text-center leading-[22px] px-6 mb-12"
//             >
//               For the safety of our community and to activate your payouts, we
//               require verification using your government-issued ID. You must be
//               a real person to monetize on our platform.
//             </Text>
//           </View>
...
//             <Text
//               style={{ fontFamily: FONT.Regular }}
//               className="text-white text-[16px] text-center mb-8"
//             >
...
export default function IdentityIntroScreen() {
  ...
  const handleNext = () => {
    router.push("/(tabs)/dashboard/identity-select");
  };
      ...
      >
        ...
        >
          ...
          <View className="pt-12 px-6">
            <View className="flex-row items-center justify-between mb-10">
              <TouchableOpacity
                onPress={() => router.push("/(tabs)/dashboard/iban")}
              >
                <ChevronLeft size={24} color="#fff" />
              </TouchableOpacity>
            ...
            <Text
              style={{ fontFamily: FONT.SemiBold }}
              className="text-[#D4AF37] text-[24px] text-center leading-[38px] mb-3"
            >
              Confirm Your Real Identity{"\n"}to Join as{" "}
              <Text style={{ color: "#FCCD34" }}>Talent</Text>
            </Text>
            ...
            <Text
              style={{ fontFamily: FONT.Regular }}
              className="text-[#A1A1AA] text-[14px] text-center leading-[20px] px-2 mb-40"
            >
              For the safety of our community and to activate your payouts, we
              require verification using your government-issued ID. You must be
              a real person to monetize on our platform.
